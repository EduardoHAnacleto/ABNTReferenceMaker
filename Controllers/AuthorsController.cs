...
namespace ABNTReferenceMaker.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(ABNTReferenceMakerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'ABNTReferenceMakerContext.Author'  is null.");
        }
        ...
        {
            if (name == null || _context.Author == null)
            {
                return NotFound();
            }

            var author = await _context.Author
                .FirstOrDefaultAsync(m => m.Name.Contains(name));
            if (author == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ABNTReferenceMakerContext.Author'  is null.");
            }
            var author = await _context.Author.FindAsync(id);
            if (author != null)
            {
